...
public class RequestBuilder {
	...
	public static String PrepareRequestByDate(MethodType methodType, String key, RequestBlocks.GetBy getBy, String value, String date) throws Exception {
		return MethodTypeParemeters.GetParameters(methodType) + "?key=" + key + "&" + ReqestFor.PrepareQueryParameter(getBy, value) + "&" + ReqestFor.PrepareDate(date);
	}
}
